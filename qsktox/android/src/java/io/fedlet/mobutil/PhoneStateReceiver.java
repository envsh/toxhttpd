...
public class PhoneStateReceiver extends BroadcastReceiver {
    private static final String CHANNEL_ID = "qsktox_call";
    private static final String PREFS_NAME = "qsktox_prefs";
    ...
    public void onReceive(Context ctx, Intent intent) {
        ...
        } else if ("io.fedlet.qsktox.ACCEPT_CALL".equals(action)) {
            acceptCall(ctx);
    ...
    private void showCallNotification(Context ctx, String number) {
        ...
        acceptIntent.setAction("io.fedlet.qsktox.ACCEPT_CALL");
