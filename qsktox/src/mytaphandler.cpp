...
quint64 MyTapHandler::m_multiTapInterval(0);
// single tap distance is the same as the drag threshold
int MyTapHandler::m_mouseMultiClickDistanceSquared(-1);
int MyTapHandler::m_touchMultiTapDistanceSquared(-1);

/*!
    \qmltype TapHandler
    \nativetype MyTapHandler
...
MyTapHandler::MyTapHandler(QQuickItem *parent)
...
bool MyTapHandler::wantsEventPoint(const QPointerEvent *event, const QEventPoint &point)
{
...
void MyTapHandler::handleEventPoint(QPointerEvent *event, QEventPoint &point)
{
...
/*!
    ...
    seconds.
*/
qreal MyTapHandler::longPressThreshold() const
{
    return m_longPressThreshold / qreal(1000);
}

void MyTapHandler::setLongPressThreshold(qreal longPressThreshold)
{
...
void MyTapHandler::resetLongPressThreshold()
{
...
void MyTapHandler::timerEvent(QTimerEvent *event)
{
...
/*!
    ...
    from reacting.
*/
void MyTapHandler::setGesturePolicy(MyTapHandler::GesturePolicy gesturePolicy)
{
...
*/
void MyTapHandler::setExclusiveSignals(MyTapHandler::ExclusiveSignals exc)
{
...
*/
void MyTapHandler::setPressed(bool press, bool cancel, QPointerEvent *event, QEventPoint &point)
{
    if (m_pressed != press) {
        m_pressed = press;
...
void MyTapHandler::onGrabChanged(QQuickPointerHandler *grabber, QPointingDevice::GrabTransition transition,
...
void MyTapHandler::connectPreRenderSignal(bool conn)
{
    ...
    */
    if (conn) {
        m_preRenderSignalConnection = connect(par->window(), &QQuickWindow::beforeSynchronizing,
                                              this, &MyTapHandler::updateTimeHeld);
    }
}

void MyTapHandler::updateTimeHeld()
{
