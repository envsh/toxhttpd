...
class MyTapHandler : public QQuickSinglePointHandler
{
    Q_OBJECT
    ...
    Q_PROPERTY(MyTapHandler::ExclusiveSignals exclusiveSignals READ exclusiveSignals WRITE setExclusiveSignals NOTIFY exclusiveSignalsChanged REVISION(6, 5))
...
public:
    ...
    explicit MyTapHandler(QQuickItem *parent = nullptr);
    ...
    MyTapHandler::ExclusiveSignals exclusiveSignals() const { return m_exclusiveSignals; }
    void setExclusiveSignals(MyTapHandler::ExclusiveSignals newexclusiveSignals);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(MyTapHandler::ExclusiveSignals)
